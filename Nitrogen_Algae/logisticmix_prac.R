...
## need column order to be in order of treatments
dat2 <- dat1 %>% select(c("date1","1.5","2.5","3.5","4.5","5.5","4","5","6","7","8","10","11","12","13","14","28","29","30","31","32",
               "55","56","57","58","59","109","110","111","112","113"))
